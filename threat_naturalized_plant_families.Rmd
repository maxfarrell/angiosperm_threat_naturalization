...
```{r frac_rare_nonvetted, echo=TRUE, eval=TRUE}
...
names1 <- c("Diversification rate","Famly age", "Woodiness","Climate sum","Number of species hybrids","Hermaphroditic","Dioecious","Monoecious","Asexual","Fleshy fruit","Animal pollinated","SD brownian effects","SD family specific effects")
...
if (!file.exists("./fit_rare_nofam_10k.rds")) {
  ...
  fit_rare_nofam <- brm(rare | trials(species) ~ diversification_scaled + new_age_scaled + woodiness + herbaceous + climate.sum + species.hybrids + hermaphroditic + dioecious + monoecious + asexual + fleshy.fruit + animal, 
    dat=data_vetted, family=binomial(), 
    iter=10000, thin=4,
    control=list(adapt_delta=0.95,max_treedepth=13))
...
names1 <- c("Diversification rate","Famly age", "Woodiness","Climate sum","Number of species hybrids","Hermaphroditic","Dioecious","Monoecious","Asexual","Fleshy fruit","Animal pollinated")
...
if (!file.exists("./fit_rare_nophylo_10k.rds")) {
  ...
  fit_rare_nophylo <- brm(rare | trials(species) ~ diversification_scaled + new_age_scaled + woodiness + herbaceous + climate.sum + species.hybrids + hermaphroditic + dioecious + monoecious + asexual + fleshy.fruit + animal + (1|family_name), 
    dat=data_vetted, family=binomial(), 
    iter=10000, thin=4,
    control=list(adapt_delta=0.95,max_treedepth=13))
...
names1 <- c("Diversification rate","Famly age", "Woodiness","Climate sum","Number of species hybrids","Hermaphroditic","Dioecious","Monoecious","Asexual","Fleshy fruit","Animal pollinated","SD family specific effects")
...
if (!file.exists("./fit_rare_phylo_10k.rds")) {
  ...
  fit_rare_phylo <- brm(rare | trials(species) ~ diversification_scaled + new_age_scaled + woodiness + herbaceous + climate.sum + species.hybrids + hermaphroditic + dioecious + monoecious + asexual + fleshy.fruit + animal+ (1|family), 
    dat=data_vetted, family=binomial(), 
...
names1 <- c("Diversification rate","Famly age", "Woodiness","Climate sum","Number of species hybrids","Hermaphroditic","Dioecious","Monoecious","Asexual","Fleshy fruit","Animal pollinated","SD brownian effects")
...
```{r, fig.width=8, fig.height=8, eval=F, echo=T}
...
ppc_dens_overlay(y=fit_inv$data$Naturalised, pp_inv[1:50, ]) + scale_x_continuous(trans="log1p")

rmse_inv <- apply(pp_inv, 1, function(x) RMSE(x,fit_inv$data$Naturalised))
...
names1 <- c("Diversification rate","Famly age", "Family Age ^2", "Woodiness","Climate sum","Number of species hybrids","Hermaphroditic","Dioecious","Monoecious","Asexual","Fleshy fruit","Animal pollinated","SD brownian effects","SD family specific effects")
...
```{r frac_rare_vetted_qa, echo=TRUE, eval=TRUE}
