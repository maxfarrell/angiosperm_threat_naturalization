...
if (!file.exists("./vet_rare_6k.rds")) {
  ...
  saveRDS(vet_rare, "./vet_rare_6k.rds")

} else { vet_rare <- readRDS("./vet_rare_6k.rds")}
...
if (!file.exists("./vet_rare_naturalized_6k.rds")) {
  ...
  saveRDS(vet_rare_nat, "./vet_rare_naturalized_6k.rds")

} else { vet_rare_nat <- readRDS("./vet_rare_naturalized_6k.rds")}
