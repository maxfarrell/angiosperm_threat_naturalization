...
ggplot(gather(data[,42:61]%>% purrr::keep(is.numeric)), aes(value)) + 
    geom_histogram(bins = 10) + 
    facet_wrap(~key, scales = 'free')
...
if (!file.exists("./rare_invasive_2k.rds")) {
  ...
  rare_inv <- brm(rare | trials(species) ~ log10(Invasive+1) + log10(age) +log10(species) +  (1|family), 
...
if (!file.exists("./rare_naturalized_2k.rds")) {
  ...
  rare_nat <- brm(rare | trials(species) ~ log10(Naturalised+1) + log10(age) +log10(species) +  (1|family), 
    dat=data, family=binomial(), 
    iter=2000, cov_ranef = list(family = phy_cov),
    control=list(adapt_delta=0.95), cores=2)
...
if (!file.exists("./rare_environmental_2k.rds")) {
  ...
  rare_env <- brm(rare | trials(species) ~ log10(Environ+1) + log10(age) +log10(species) +  (1|family), 
    dat=data, family=binomial(), 
    iter=2000, cov_ranef = list(family = phy_cov),
    control=list(adapt_delta=0.95), cores=2)
...
if (!file.exists("./fit_rare_2k.rds")) {
  ...
  fit_rare <- brm(rare | trials(species) ~ forms2 + annual + perennial + woody + succulent + climate.sum + ghybrids + shybrids + log10(age) + log10(species) + hermaphroditic + dioec2 + monoec2 + asexual + animal + (1 | family), 
    dat=data, family=binomial(), 
    iter=2000, cov_ranef = list(family = phy_cov),
...
posterior_rare <- as.array(fit_rare)
np_rare <- nuts_params(fit_rare)
mcmc_pairs(posterior_rare, np = np_rare, pars=rownames(to_print))
...
if (!file.exists("./fit_nat_2k.rds")) {
  ...
  fit_nat <- brm(Naturalised | trials(species) ~ forms2 + annual + perennial + woody + succulent + climate.sum + ghybrids + shybrids + log10(age) + log10(species) + hermaphroditic + dioec2 + monoec2 + asexual + animal + (1 | family), 
    dat=data, family=binomial(), 
    iter=2000, cov_ranef = list(family = phy_cov),
...
if (!file.exists("./fit_inv_2k.rds")) {
  ...
  fit_inv <- brm(Invasive | trials(species) ~ forms2 + annual + perennial + woody + succulent + climate.sum + ghybrids + shybrids + log10(age) + log10(species) + hermaphroditic + dioec2 + monoec2 + asexual + animal + (1 | family), 
    dat=data, family=binomial(), 
    iter=2000, cov_ranef = list(family = phy_cov),
...
if (!file.exists("./fit_weed_2k.rds")) {
  ...
  fit_weed <- brm(Weed | trials(species) ~ forms2 + annual + perennial + woody + succulent + climate.sum + ghybrids + shybrids + log10(age) + log10(species) + hermaphroditic + dioec2 + monoec2 + asexual + animal + (1 | family), 
    dat=data, family=binomial(), 
    iter=2000, cov_ranef = list(family = phy_cov),
    control=list(adapt_delta=0.8, max_treedepth=11), cores=2)
...
if (!file.exists("./fit_ag_2k.rds")) {
  ...
  fit_ag <- brm(Agricultural.Weed | trials(species) ~ forms2 + annual + perennial + woody + succulent + climate.sum + ghybrids + shybrids + log10(age) + log10(species) + hermaphroditic + dioec2 + monoec2 + asexual + animal + (1 | family), 
    dat=data, family=binomial(), 
    iter=2000, cov_ranef = list(family = phy_cov),
    control=list(adapt_delta=0.8, max_treedepth=11), cores=2)
...
if (!file.exists("./fit_env_2k.rds")) {
  ...
  fit_env <- brm(Environ | trials(species) ~ forms2 + annual + perennial + woody + succulent + climate.sum + ghybrids + shybrids + log10(age) + log10(species) + hermaphroditic + dioec2 + monoec2 + asexual + animal + (1 | family), 
    dat=data, family=binomial(), 
    iter=2000, cov_ranef = list(family = phy_cov),
    control=list(adapt_delta=0.8, max_treedepth=11))
...
if (!file.exists("./fit_nox_2k.rds")) {
  ...
  fit_nox <- brm(Noxious | trials(species) ~ forms2 + annual + perennial + woody + succulent + climate.sum + ghybrids + shybrids + log10(age) + log10(species) + hermaphroditic + dioec2 + monoec2 + asexual + animal + (1 | family), 
    dat=data, family=binomial(), 
    iter=2000, cov_ranef = list(family = phy_cov),
    control=list(adapt_delta=0.8, max_treedepth=11))
