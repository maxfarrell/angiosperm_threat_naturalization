...
if (!file.exists("./rare_invasive_6k.rds")) {

  rare_inv <- brm(rare | trials(species) ~ log10(Invasive+1) + log10(new_age) +log10(species) +  (1|family) + (1|family_name), 
    dat=data, family=binomial(), 
    iter=6000, thin = 4, cov_ranef = list(family = phy_cov),
    control=list(adapt_delta=0.95,max_treedepth=12), cores=4)

  saveRDS(rare_inv, "./rare_invasive_6k.rds")

} else { rare_inv <- readRDS("./rare_invasive_6k.rds")}
...
if (!file.exists("./rare_naturalized_6k.rds")) {

  rare_nat <- brm(rare | trials(species) ~ log10(Naturalised+1) + log10(new_age) +log10(species) +  (1|family) + (1|family_name), 
    dat=data, family=binomial(), 
    iter=6000, thin=2, cov_ranef = list(family = phy_cov),
    control=list(adapt_delta=0.95,max_treedepth=12), cores=4)

  saveRDS(rare_nat, "./rare_naturalized_6k.rds")

} else { rare_nat <- readRDS("./rare_naturalized_6k.rds")}
...
if (!file.exists("./rare_environmental_6k.rds")) {

  rare_env <- brm(rare | trials(species) ~ log10(Environ+1) + log10(new_age) +log10(species) +  (1|family) + (1|family_name), 
    dat=data, family=binomial(), 
    iter=6000, thin=2, cov_ranef = list(family = phy_cov),
    control=list(adapt_delta=0.95,max_treedepth=12), cores=4)

  saveRDS(rare_env, "./rare_environmental_6k.rds")

} else { rare_env <- readRDS("./rare_environmental_6k.rds")}
...
if (!file.exists("./fit_rare_6k.rds")) {

  fit_rare <- brm(rare | trials(species) ~ woodiness + climate.sum + shybrids + log10(new_age) + log10(species) + hermaphroditic + dioec2 + monoec2 + asexual + (1|family) + (1|family_name), 
    dat=data, family=binomial(), 
    iter=6000, thin=2, cov_ranef = list(family = phy_cov),
    control=list(adapt_delta=0.95,max_treedepth=13))

  saveRDS(fit_rare, "./fit_rare_6k.rds")

} else { fit_rare <- readRDS("./fit_rare_6k.rds")}
...
if (!file.exists("./fit_nat_6k.rds")) {
  ...
  saveRDS(fit_nat, "./fit_nat_6k.rds")

} else { fit_nat <- readRDS("./fit_nat_6k.rds")}
...
if (!file.exists("./fit_inv_6k.rds")) {
  ...
  saveRDS(fit_inv, "./fit_inv_6k.rds")

} else { fit_inv <- readRDS("./fit_inv_6k.rds")}
...
if (!file.exists("./vet_rare_4k.rds")) {

  vet_rare <- brm(rare | trials(vetted) ~ woodiness + climate.sum + shybrids + log10(new_age) + log10(species) + hermaphroditic + dioec2 + monoec2 + asexual + (1|family) + (1|family_name), 
    dat=data_vetted, family=binomial(), 
    iter=40, thin=2, cov_ranef = list(family = phy_cov_vetted),
    control=list(adapt_delta=0.95,max_treedepth=13))

  saveRDS(vet_rare, "./vet_rare_4k.rds")

} else { vet_rare <- readRDS("./vet_rare_4k.rds")}

# vet_rare

outcome <- summary(vet_rare$vet)
to_print <- outcome$summary[grep("^[sd,b]_*",rownames(outcome$summary)),]
to_print <- to_print[-1,]
...
if (!file.exists("./vet_rare_naturalized_4k.rds")) {

  vet_rare_nat <- brm(rare | trials(vetted) ~ log10(Naturalised+1) + log10(new_age) +log10(species) +  (1|family) + (1|family_name), 
    dat=data_vetted, family=binomial(), 
    iter=6000, thin=2, cov_ranef = list(family = phy_cov_vetted),
    control=list(adapt_delta=0.95,max_treedepth=12), cores=4)

  saveRDS(vet_rare_nat, "./vet_rare_naturalized_4k.rds")

} else { vet_rare_nat <- readRDS("./vet_rare_naturalized_4k.rds")}
...
if (!file.exists("./fit_weed_6k.rds")) {
  ...
  saveRDS(fit_weed, "./fit_weed_6k.rds")

} else { fit_weed <- readRDS("./fit_weed_6k.rds")}
...
if (!file.exists("./fit_ag_6k.rds")) {
  ...
  saveRDS(fit_ag, "./fit_ag_6k.rds")

} else { fit_ag <- readRDS("./fit_ag_6k.rds")}
...
if (!file.exists("./fit_env_6k.rds")) {
  ...
  saveRDS(fit_env, "./fit_env_6k.rds")

} else { fit_env <- readRDS("./fit_env_6k.rds")}
...
if (!file.exists("./fit_nox_6k.rds")) {
  ...
  saveRDS(fit_nox, "./fit_nox_6k.rds")

} else { fit_nox <- readRDS("./fit_nox_6k.rds")}
