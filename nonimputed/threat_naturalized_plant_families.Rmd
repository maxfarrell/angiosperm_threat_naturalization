...
# one family has more threatened species than species
data[data$threatened>data$species,]

# increasing species by 1 to match
data$species[data$family=="Asteropeiaceae"] <- 6

nrow(data)# 404
range(data$vetted)# 0-1992
nrow(data[data$vetted>0,])# 208

# Changing "species.hybrids" to "hybrids"
data <- data %>% rename(hybrids = species.hybrids) 
...
vif(lm(threatened ~ naturalized_scaled + diversification_scaled + new_age_scaled, data=data_vetted))

vif(lm(threatened ~ diversification_scaled + new_age_scaled +  hybrids + animal + fleshy.fruit + climate.sum + herbaceous + annual + asexual, data=data_vetted))

vif(lm(threatened ~ diversification_scaled + new_age_scaled +  hybrids + animal + fleshy.fruit + climate.sum + herbaceous + annual + asexual, data=data))
...
if (!file.exists("./vet_threatened_naturalized_10k.rds")) {
  ...
  vet_threatened_nat <- brm(threatened | trials(vetted) ~ naturalized_scaled + diversification_scaled + new_age_scaled +  (1|family) + (1|family_name), 
...
if (!file.exists("./vet_threatened_naturalized_p2_10k.rds")) {
  ...
  vet_threatened_nat_p2 <- brm(threatened | trials(vetted) ~ naturalized_scaled + diversification_scaled + new_age_scaled +  (1|family) + (1|family_name), 
    dat=data_vetted, family=binomial(),
...
if (!file.exists("./vet_threatened_10k.rds")) {
  ...
  vet_threatened <- brm(threatened | trials(vetted) ~ diversification_scaled + new_age_scaled +  hybrids + animal + fleshy.fruit + climate.sum + herbaceous + annual + asexual + (1|family) + (1|family_name), 
    dat=data_vetted, family=binomial(), 
    iter=10000, thin=4, cov_ranef = list(family = phy_cov_vetted),
...
names1 <- c("Diversification rate","Famly age", "Hybrids","Animal pollinated", "Fleshy fruit", "Climate sum","Herbaceous","Annual","Axsexual","SD brownian effects","SD family specific effects")
...
if (!file.exists("./vet_threatened_p2_10k.rds")) {
  ...
  vet_threatened_p2 <- brm(threatened | trials(vetted) ~ diversification_scaled + new_age_scaled +  hybrids + animal + fleshy.fruit + climate.sum + herbaceous + annual + asexual + (1|family) + (1|family_name), 
...
if (!file.exists("./fit_nat_10k.rds")) {
  ...
  fit_nat <- brm(naturalized | trials(species) ~ diversification_scaled + new_age_scaled +  hybrids + animal + fleshy.fruit + climate.sum + herbaceous + annual + asexual + (1|family) + (1|family_name), 
...
labels=c("Diversification rate","Family age","Hybrids", "Animal pollination", "Fleshy fruits", "Climate range variability", "Herbaceous","Annual","Asexual seed production", "SD Brownian effects","SD family specific effects")
...
if (!file.exists("./vet_threatened_nofam_10k.rds")) {
  ...
  vet_threatened_nofam <- brm(threatened | trials(vetted) ~ diversification_scaled + new_age_scaled +  hybrids + animal + fleshy.fruit + climate.sum + herbaceous + annual + asexual, 
    dat=data_vetted, family=binomial(), 
    iter=10000, thin=4,
...
names1 <- c("Diversification rate","Famly age", "Hybrids","Animal pollinated", "Fleshy fruit", "Climate sum","Herbaceous","Annual","Axsexual")
...
if (!file.exists("./vet_threatened_nophylo_10k.rds")) {
  ...
  vet_threatened_nophylo <- brm(threatened | trials(vetted) ~ diversification_scaled + new_age_scaled +  hybrids + animal + fleshy.fruit + climate.sum + herbaceous + annual + asexual + (1|family_name), 
    dat=data_vetted, family=binomial(), 
    iter=10000, thin=4,
    control=list(adapt_delta=0.95,max_treedepth=13))
...
names1 <- c("Diversification rate","Famly age", "Hybrids","Animal pollinated", "Fleshy fruit", "Climate sum","Herbaceous","Annual","Axsexual","SD brownian effects")
...
if (!file.exists("./vet_threatened_phylo_10k.rds")) {
  ...
  vet_threatened_phylo <- brm(threatened | trials(vetted) ~ diversification_scaled + new_age_scaled +  hybrids + animal + fleshy.fruit + climate.sum + herbaceous + annual + asexual+ (1|family), 
    dat=data_vetted, family=binomial(), 
    iter=10000, thin=4, cov_ranef = list(family = phy_cov),
    control=list(adapt_delta=0.95,max_treedepth=13))
...
if (!file.exists("./nonvet_threatened_10k.rds")) {
  ...
  nonvet_threatened <- brm(threatened | trials(species) ~ diversification_scaled + new_age_scaled +  hybrids + animal + fleshy.fruit + climate.sum + herbaceous + annual + asexual + (1|family) + (1|family_name), 
    dat=data, family=binomial(), 
    iter=10000, thin=4, cov_ranef = list(family = phy_cov),
    control=list(adapt_delta=0.95,max_treedepth=13))
...
if (!file.exists("./fit_inv_10k.rds")) {
  ...
  fit_inv <- brm(invasive | trials(species) ~ diversification_scaled + new_age_scaled +  hybrids + animal + fleshy.fruit + climate.sum + herbaceous + annual + asexual + (1|family) + (1|family_name), 
    dat=data, family=binomial(), 
    iter=10000, thin=4, cov_ranef = list(family = phy_cov),
    control=list(adapt_delta=0.8, max_treedepth=11))
